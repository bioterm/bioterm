...
class ServiceAccountsApi:
    ...
    def create_service_account(
        self,
        create_service_account_form: Optional[CreateServiceAccountForm] = None,
        ...
        _param = self._create_service_account_serialize(
            create_service_account_form=create_service_account_form,
    ...
    def _create_service_account_serialize(
        ...
        if create_service_account_form is not None:
            _body_params = create_service_account_form
    ...
    def create_token(
        self,
        service_account_id: StrictInt,
        add_service_account_token_command: Optional[AddServiceAccountTokenCommand] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._create_token_serialize(
            ...
            add_service_account_token_command=add_service_account_token_command,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_token_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if add_service_account_token_command is not None:
            _body_params = add_service_account_token_command
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/serviceaccounts/{serviceAccountId}/tokens',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_service_account_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/serviceaccounts/{serviceAccountId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_token_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/serviceaccounts/{serviceAccountId}/tokens/{tokenId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def retrieve_service_account(
        ...
        _param = self._retrieve_service_account_serialize(
            service_account_id=service_account_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def retrieve_service_account_with_http_info(
        self,
        service_account_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def retrieve_service_account_without_preload_content(
        self,
        service_account_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _retrieve_service_account_serialize(
        self,
        service_account_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def search_org_service_accounts_with_paging(
        self,
        disabled: Optional[StrictBool] = None,
        expired_tokens: Optional[StrictBool] = None,
        query: Annotated[Optional[StrictStr], Field(description="It will return results where the query value is contained in one of the name. Query values with spaces need to be URL encoded.")] = None,
        perpage: Annotated[Optional[StrictInt], Field(description="The default value is 1000.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="The default value is 1.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._search_org_service_accounts_with_paging_serialize(
            disabled=disabled,
    ...
    @validate_call
    def search_org_service_accounts_with_paging_with_http_info(
        self,
        disabled: Optional[StrictBool] = None,
        expired_tokens: Optional[StrictBool] = None,
        query: Annotated[Optional[StrictStr], Field(description="It will return results where the query value is contained in one of the name. Query values with spaces need to be URL encoded.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchOrgServiceAccountsResult]:
        """Search service accounts with paging
    ...
    @validate_call
    def search_org_service_accounts_with_paging_without_preload_content(
        self,
        disabled: Optional[StrictBool] = None,
        expired_tokens: Optional[StrictBool] = None,
        query: Annotated[Optional[StrictStr], Field(description="It will return results where the query value is contained in one of the name. Query values with spaces need to be URL encoded.")] = None,
    ...
    def _search_org_service_accounts_with_paging_serialize(
        self,
        disabled,
        expired_tokens,
        query,
        ...
        if expired_tokens is not None:
            ...
            _query_params.append(('expiredTokens', expired_tokens))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/serviceaccounts/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_service_account(
        self,
        service_account_id: StrictInt,
        update_service_account_form: Optional[UpdateServiceAccountForm] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_service_account_serialize(
            service_account_id=service_account_id,
            update_service_account_form=update_service_account_form,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def update_service_account_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateServiceAccount200Response]:
        """Update service account
    ...
    def _update_service_account_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_service_account_form is not None:
            _body_params = update_service_account_form
