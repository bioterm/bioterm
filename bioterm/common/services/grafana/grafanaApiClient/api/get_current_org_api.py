...
class GetCurrentOrgApi:
    ...
    def get_current_org_quota(
        ...
        _param = self._get_current_org_quota_serialize(
    ...
    @validate_call
    def get_current_org_quota_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_current_org_quota_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_current_org_quota_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
