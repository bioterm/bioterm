...
class SigningKeysApi:
    ...
    def retrieve_jwks(
        ...
        _param = self._retrieve_jwks_serialize(
    ...
    @validate_call
    def retrieve_jwks_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RetrieveJWKS200Response]:
        """Get JSON Web Key Set (JWKS) with all the keys that can be used to verify tokens (public keys)
    ...
    @validate_call
    def retrieve_jwks_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _retrieve_jwks_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/signing-keys/keys',
