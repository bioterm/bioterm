...
class AdminApi:
    ...
    def admin_get_settings(
        ...
        _param = self._admin_get_settings_serialize(
    ...
    @validate_call
    def admin_get_settings_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def admin_get_settings_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _admin_get_settings_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def admin_get_stats(
        ...
        _param = self._admin_get_stats_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def admin_get_stats_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def admin_get_stats_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _admin_get_stats_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def pause_all_alerts(
        self,
        pause_all_alerts_command: PauseAllAlertsCommand,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._pause_all_alerts_serialize(
            pause_all_alerts_command=pause_all_alerts_command,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def pause_all_alerts_with_http_info(
        self,
        pause_all_alerts_command: PauseAllAlertsCommand,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PauseAllAlerts200Response]:
        """Pause/unpause all (legacy) alerts.
    ...
    @validate_call
    def pause_all_alerts_without_preload_content(
        self,
        pause_all_alerts_command: PauseAllAlertsCommand,
        _request_timeout: Union[
            None,
    ...
    def _pause_all_alerts_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if pause_all_alerts_command is not None:
            _body_params = pause_all_alerts_command
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/pause-all-alerts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
