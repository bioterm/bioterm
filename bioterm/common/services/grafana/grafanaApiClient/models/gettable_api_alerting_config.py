...
class GettableApiAlertingConfig(BaseModel):
    ...
    mute_time_provenances: Optional[Dict[str, StrictStr]] = Field(default=None, alias="muteTimeProvenances")
    mute_time_intervals: Optional[List[MuteTimeInterval]] = None
    receivers: Optional[List[GettableApiReceiver]] = Field(default=None, description="Override with our superset receiver type")
    route: Optional[Route] = None
    templates: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["global", "inhibit_rules", "muteTimeProvenances", "mute_time_intervals", "receivers", "route", "templates"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "muteTimeProvenances": obj.get("muteTimeProvenances"),
