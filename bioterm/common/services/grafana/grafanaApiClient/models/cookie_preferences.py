...
class CookiePreferences(BaseModel):
    ...
    CookiePreferences
    """ # noqa: E501
    analytics: Optional[Union[str, Any]] = None
    functional: Optional[Union[str, Any]] = None
    performance: Optional[Union[str, Any]] = None
    __properties: ClassVar[List[str]] = ["analytics", "functional", "performance"]
