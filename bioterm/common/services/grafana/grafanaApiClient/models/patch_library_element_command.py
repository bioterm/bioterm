...
class PatchLibraryElementCommand(BaseModel):
    ...
    version: Optional[StrictInt] = Field(default=None, description="Version of the library element you are updating.")
    __properties: ClassVar[List[str]] = ["folderId", "folderUid", "kind", "model", "name", "uid", "version"]
