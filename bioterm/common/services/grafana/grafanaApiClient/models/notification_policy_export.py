...
class NotificationPolicyExport(BaseModel):
    """
    NotificationPolicyExport
    """ # noqa: E501
    policy: Optional[RouteExport] = Field(default=None, alias="Policy")
    org_id: Optional[StrictInt] = Field(default=None, alias="orgId")
    __properties: ClassVar[List[str]] = ["Policy", "orgId"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "Policy": RouteExport.from_dict(obj.get("Policy")) if obj.get("Policy") is not None else None,
            "orgId": obj.get("orgId")
        })
        return _obj
