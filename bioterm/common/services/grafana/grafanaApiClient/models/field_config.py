...
class FieldConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["color", "custom", "decimals", "description", "displayName", "displayNameFromDS", "filterable", "interval", "links", "mappings", "max", "min", "noValue", "path", "thresholds", "type", "unit", "writeable"]
