...
class CorrelationConfigUpdateDTO(BaseModel):
    ...
    """ # noqa: E501
    field: Optional[StrictStr] = Field(default=None, description="Field used to attach the correlation link")
    target: Optional[Union[str, Any]] = Field(default=None, description="Target data query")
    transformations: Optional[List[Transformation]] = Field(default=None, description="Source data transformations")
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["field", "target", "transformations", "type"]
