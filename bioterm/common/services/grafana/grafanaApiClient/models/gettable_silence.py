...
class GettableSilence(BaseModel):
    ...
    matchers: List[Matcher] = Field(description="Matchers matchers")
    ...
    __properties: ClassVar[List[str]] = ["comment", "createdBy", "endsAt", "id", "matchers", "startsAt", "status", "updatedAt"]
