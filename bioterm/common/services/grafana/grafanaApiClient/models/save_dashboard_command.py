...
class SaveDashboardCommand(BaseModel):
    """
    SaveDashboardCommand
    """ # noqa: E501
    updated_at: Optional[datetime] = Field(default=None, alias="UpdatedAt")
    dashboard: Optional[Union[str, Any]] = None
    ...
    __properties: ClassVar[List[str]] = ["UpdatedAt", "dashboard", "folderId", "folderUid", "isFolder", "message", "overwrite", "userId"]
