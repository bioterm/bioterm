...
class CreateOrUpdateConfigCmd(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dashboardId", "dashboardUid", "dashboards", "enableCsv", "enableDashboardUrl", "formats", "message", "name", "options", "recipients", "replyTo", "scaleFactor", "schedule", "state", "templateVars"]
