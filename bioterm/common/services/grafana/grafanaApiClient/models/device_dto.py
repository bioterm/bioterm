...
class DeviceDTO(BaseModel):
    ...
    last_seen_at: Optional[StrictStr] = Field(default=None, alias="lastSeenAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    user_agent: Optional[StrictStr] = Field(default=None, alias="userAgent")
    __properties: ClassVar[List[str]] = ["avatarUrl", "clientIp", "createdAt", "deviceId", "lastSeenAt", "updatedAt", "userAgent"]
