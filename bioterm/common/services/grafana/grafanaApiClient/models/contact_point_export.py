...
class ContactPointExport(BaseModel):
    """
    ContactPointExport
    """ # noqa: E501
    name: Optional[StrictStr] = None
    org_id: Optional[StrictInt] = Field(default=None, alias="orgId")
    receivers: Optional[List[ReceiverExport]] = None
    __properties: ClassVar[List[str]] = ["name", "orgId", "receivers"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "orgId": obj.get("orgId"),
            "receivers": [ReceiverExport.from_dict(_item) for _item in obj.get("receivers")] if obj.get("receivers") is not None else None
        })
        return _obj
