...
class AlertTestResult(BaseModel):
    ...
    AlertTestResult
    """ # noqa: E501
    condition_evals: Optional[StrictStr] = Field(default=None, alias="conditionEvals")
    error: Optional[StrictStr] = None
    firing: Optional[StrictBool] = None
    logs: Optional[List[AlertTestResultLog]] = None
    matches: Optional[List[EvalMatch]] = None
    state: Optional[StrictStr] = None
    time_ms: Optional[StrictStr] = Field(default=None, alias="timeMs")
    __properties: ClassVar[List[str]] = ["conditionEvals", "error", "firing", "logs", "matches", "state", "timeMs"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "conditionEvals": obj.get("conditionEvals"),
            "error": obj.get("error"),
