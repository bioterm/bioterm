...
class PostableAlert(BaseModel):
    ...
    """ # noqa: E501
    annotations: Optional[Dict[str, StrictStr]] = Field(default=None, description="LabelSet label set")
    ends_at: Optional[datetime] = Field(default=None, description="ends at Format: date-time", alias="endsAt")
    ...
    starts_at: Optional[datetime] = Field(default=None, description="starts at Format: date-time", alias="startsAt")
    __properties: ClassVar[List[str]] = ["annotations", "endsAt", "generatorURL", "labels", "startsAt"]
