...
class RouteExport(BaseModel):
    ...
    routes: Optional[List[RouteExport]] = None
    __properties: ClassVar[List[str]] = ["continue", "group_by", "group_interval", "group_wait", "match", "match_re", "matchers", "mute_time_intervals", "object_matchers", "receiver", "repeat_interval", "routes"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "routes": [RouteExport.from_dict(_item) for _item in obj.get("routes")] if obj.get("routes") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
RouteExport.model_rebuild(raise_errors=False)
