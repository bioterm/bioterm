...
class Field(BaseModel):
    ...
    labels: Optional[Dict[str, StrictStr]] = Field(default=None, description="Labels are used to add metadata to an object.  The JSON will always be sorted keys")
    name: Optional[StrictStr] = Field(default=None, description="Name is default identifier of the field. The name does not have to be unique, but the combination of name and Labels should be unique for proper behavior in all situations.")
    __properties: ClassVar[List[str]] = ["config", "labels", "name"]
