...
class ImportDashboardResponse(BaseModel):
    ...
    imported_revision: Optional[StrictInt] = Field(default=None, alias="importedRevision")
    imported_uri: Optional[StrictStr] = Field(default=None, alias="importedUri")
    imported_url: Optional[StrictStr] = Field(default=None, alias="importedUrl")
    ...
    __properties: ClassVar[List[str]] = ["dashboardId", "description", "folderId", "folderUid", "imported", "importedRevision", "importedUri", "importedUrl", "path", "pluginId", "removed", "revision", "slug", "title", "uid"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "importedRevision": obj.get("importedRevision"),
            "importedUri": obj.get("importedUri"),
            "importedUrl": obj.get("importedUrl"),
            "path": obj.get("path"),
