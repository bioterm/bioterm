...
class TimeInterval(BaseModel):
    ...
    """ # noqa: E501
    days_of_month: Optional[List[StrictStr]] = None
    location: Optional[StrictStr] = None
    months: Optional[List[StrictStr]] = None
    times: Optional[List[TimeRange]] = None
    weekdays: Optional[List[StrictStr]] = None
    years: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["days_of_month", "location", "months", "times", "weekdays", "years"]
