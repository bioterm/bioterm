...
class SearchResultItem(BaseModel):
    ...
    basic_role: Optional[StrictStr] = Field(default=None, alias="basicRole")
    ...
    __properties: ClassVar[List[str]] = ["action", "basicRole", "orgId", "roleName", "scope", "teamId", "userId", "version"]
