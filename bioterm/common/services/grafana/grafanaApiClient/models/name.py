...
class Name(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "ExtraNames": [AttributeTypeAndValue.from_dict(_item) for _item in obj.get("ExtraNames")] if obj.get("ExtraNames") is not None else None,
            "Locality": obj.get("Locality"),
            "Names": [AttributeTypeAndValue.from_dict(_item) for _item in obj.get("Names")] if obj.get("Names") is not None else None,
