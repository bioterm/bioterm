...
class PostableExtendedRuleNodeExtended(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["folderTitle", "folderUid", "rule", "ruleGroup"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "rule": PostableExtendedRuleNode.from_dict(obj.get("rule")) if obj.get("rule") is not None else None,
