...
class TestRuleResponse(BaseModel):
    ...
    TestRuleResponse
    """ # noqa: E501
    alerts: Optional[List[Sample]] = Field(default=None, description="Vector is basically only an alias for model.Samples, but the contract is that in a Vector, all Samples have the same timestamp.")
    grafana_alert_instances: Optional[AlertInstancesResponse] = None
    __properties: ClassVar[List[str]] = ["alerts", "grafana_alert_instances"]
