...
class MassDeleteAnnotationsCmd(BaseModel):
    """
    MassDeleteAnnotationsCmd
    """ # noqa: E501
    annotation_id: Optional[StrictInt] = Field(default=None, alias="annotationId")
    ...
    __properties: ClassVar[List[str]] = ["annotationId", "dashboardId", "dashboardUID", "panelId"]
