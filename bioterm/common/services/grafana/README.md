...
*AdminProvisioningApi* | [**admin_provisioning_reload_notifications**](docs/AdminProvisioningApi.md#admin_provisioning_reload_notifications) | **POST** /admin/provisioning/notifications/reload | Reload legacy alert notifier provisioning configurations.
