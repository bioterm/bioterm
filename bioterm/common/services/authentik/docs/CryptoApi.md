...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    api_instance = authentikApiClient.CryptoApi(api_client)
    certificate_key_pair_request = authentikApiClient.CertificateKeyPairRequest() # CertificateKeyPairRequest | 
...
with authentikApiClient.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentikApiClient.CryptoApi(api_client)
    certificate_generation_request = authentikApiClient.CertificateGenerationRequest() # CertificateGenerationRequest | 
...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    managed = 'managed_example' # str | managed (optional)
...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    api_instance = authentikApiClient.CryptoApi(api_client)
    kp_uuid = 'kp_uuid_example' # str | A UUID string identifying this Certificate-Key Pair.
    patched_certificate_key_pair_request = authentikApiClient.PatchedCertificateKeyPairRequest() # PatchedCertificateKeyPairRequest |  (optional)
