...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    api_instance = authentikApiClient.FlowsApi(api_client)
    flow_stage_binding_request = authentikApiClient.FlowStageBindingRequest() # FlowStageBindingRequest | 
...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    api_instance = authentikApiClient.FlowsApi(api_client)
    fsb_uuid = 'fsb_uuid_example' # str | A UUID string identifying this Flow Stage Binding.
    patched_flow_stage_binding_request = authentikApiClient.PatchedFlowStageBindingRequest() # PatchedFlowStageBindingRequest |  (optional)
...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    flow_slug = 'flow_slug_example' # str | 
    query = 'query_example' # str | Querystring as received
    flow_challenge_response_request = authentikApiClient.FlowChallengeResponseRequest() # FlowChallengeResponseRequest |  (optional)
...
with authentikApiClient.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentikApiClient.FlowsApi(api_client)
    flow_request = authentikApiClient.FlowRequest() # FlowRequest | 
...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    api_instance = authentikApiClient.FlowsApi(api_client)
    slug = 'slug_example' # str | 
    patched_flow_request = authentikApiClient.PatchedFlowRequest() # PatchedFlowRequest |  (optional)
