...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    api_instance = authentikApiClient.ManagedApi(api_client)
...
with authentikApiClient.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentikApiClient.ManagedApi(api_client)
    blueprint_instance_request = authentikApiClient.BlueprintInstanceRequest() # BlueprintInstanceRequest | 
...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    api_instance = authentikApiClient.ManagedApi(api_client)
    instance_uuid = 'instance_uuid_example' # str | A UUID string identifying this Blueprint Instance.
    patched_blueprint_instance_request = authentikApiClient.PatchedBlueprintInstanceRequest() # PatchedBlueprintInstanceRequest |  (optional)
