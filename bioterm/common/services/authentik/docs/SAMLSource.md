...
**signing_kp** | **str** | Keypair which is used to sign outgoing requests. Leave empty to disable signing. | [optional] 
...
saml_source_form_dict = saml_source.from_dict(saml_source_dict)
```
