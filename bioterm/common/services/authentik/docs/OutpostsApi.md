# authentikApiClient.OutpostsApi
...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    api_instance = authentikApiClient.OutpostsApi(api_client)
    outpost_request = authentikApiClient.OutpostRequest() # OutpostRequest | 
...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    api_instance = authentikApiClient.OutpostsApi(api_client)
    uuid = 'uuid_example' # str | A UUID string identifying this outpost.
    patched_outpost_request = authentikApiClient.PatchedOutpostRequest() # PatchedOutpostRequest |  (optional)
...
with authentikApiClient.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentikApiClient.OutpostsApi(api_client)
    docker_service_connection_request = authentikApiClient.DockerServiceConnectionRequest() # DockerServiceConnectionRequest | 
...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    api_instance = authentikApiClient.OutpostsApi(api_client)
    uuid = 'uuid_example' # str | A UUID string identifying this Docker Service-Connection.
    patched_docker_service_connection_request = authentikApiClient.PatchedDockerServiceConnectionRequest() # PatchedDockerServiceConnectionRequest |  (optional)
...
with authentikApiClient.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentikApiClient.OutpostsApi(api_client)
    kubernetes_service_connection_request = authentikApiClient.KubernetesServiceConnectionRequest() # KubernetesServiceConnectionRequest | 
...
with authentikApiClient.ApiClient(configuration) as api_client:
    ...
    api_instance = authentikApiClient.OutpostsApi(api_client)
    uuid = 'uuid_example' # str | A UUID string identifying this Kubernetes Service-Connection.
    patched_kubernetes_service_connection_request = authentikApiClient.PatchedKubernetesServiceConnectionRequest() # PatchedKubernetesServiceConnectionRequest |  (optional)
