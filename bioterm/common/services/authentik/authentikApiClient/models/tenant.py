...
class Tenant(BaseModel):
    ...
    domain: StrictStr = Field(description="Domain that activates this tenant. Can be a superset, i.e. `a.b` for `aa.b` and `ba.b`")
    ...
    __properties: ClassVar[List[str]] = ["tenant_uuid", "domain", "default", "branding_title", "branding_logo", "branding_favicon", "flow_authentication", "flow_invalidation", "flow_recovery", "flow_unenrollment", "flow_user_settings", "flow_device_code", "event_retention", "web_certificate", "attributes"]
