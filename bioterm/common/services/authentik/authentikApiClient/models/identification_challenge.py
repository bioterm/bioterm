...
class IdentificationChallenge(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "flow_info", "component", "response_errors", "user_fields", "password_fields", "application_pre", "enroll_url", "recovery_url", "passwordless_url", "primary_action", "sources", "show_source_labels"]
