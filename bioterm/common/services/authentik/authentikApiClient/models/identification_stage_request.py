...
class IdentificationStageRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "flow_set", "user_fields", "password_stage", "case_insensitive_matching", "show_matched_user", "enrollment_flow", "recovery_flow", "passwordless_flow", "sources", "show_source_labels"]
