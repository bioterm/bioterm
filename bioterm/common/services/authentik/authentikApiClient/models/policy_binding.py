...
class PolicyBinding(BaseModel):
    ...
    timeout: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]] = Field(default=None, description="Timeout after which Policy execution is terminated.")
    __properties: ClassVar[List[str]] = ["pk", "policy", "group", "user", "policy_obj", "group_obj", "user_obj", "target", "negate", "enabled", "order", "timeout"]
