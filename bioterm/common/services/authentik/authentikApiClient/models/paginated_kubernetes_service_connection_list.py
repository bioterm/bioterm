...
class PaginatedKubernetesServiceConnectionList(BaseModel):
    ...
    """ # noqa: E501
    pagination: PaginatedApplicationListPagination
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "pagination": PaginatedApplicationListPagination.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None,
            "results": [KubernetesServiceConnection.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
