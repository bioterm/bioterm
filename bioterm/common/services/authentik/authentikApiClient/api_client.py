...
import authentikApiClient.models
from authentikApiClient import rest
from authentikApiClient.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(authentikApiClient.models, klass)
